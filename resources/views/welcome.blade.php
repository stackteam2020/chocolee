...
<head>
  ...
  <body>
    <header class="header header--1" data-sticky="true">
      ...
      <div class="header__center"><a class="ps-logo" href="index-2.html"><img src="{{asset('img/logo.png')}}" alt=""></a></div>
            ...
            <div class="ps-cart__content">
              <div class="ps-cart__items">
                <div class="ps-product--mini-cart">
                  <div class="ps-product__thumbnail"><a href="#"><img src="{{asset('img/product/12.png')}}" alt=""></a></div>
                ...
                <div class="ps-product--mini-cart">
                  <div class="ps-product__thumbnail"><a href="#"><img src="{{asset('img/product/13.png')}}" alt=""></a></div>
                  <div class="ps-product__content"><span class="ps-btn--close"></span><a class="ps-product__title" href="product-default.html">Jean Woman Summer</a>
                    <p><strong>Quantity: 1</strong></p><small>$12.00</small>
                  </div>
                </div>
    ...
    <div class="ps-modal" id="menu-fullscreen">
      <div class="header--fullscreen ps-modal__container bg--cover" data-background="{{asset('img/bg/menu-bg.jpg')}}"><a class="ps-modal__close ps-btn--close" href="#"></a>
        <div class="header__top"><a class="ps-logo" href="#"><img src="{{asset('img/logo.png')}}" alt=""></a></div>
    ...
    <header class="header header--mobile" data-sticky="false">
      <div class="header__content">
        ...
        <div class="header__center"><a class="ps-logo" href="#"><img src="{{asset('img/logo.png')}}" alt=""></a></div>
        <div class="header__right">
    ...
    <div class="ps-panel--sidebar" id="navigation-mobile">
      ...
      <div class="ps-panel__content">
        <ul class="menu--mobile">
          <li class="current-menu-item menu-item-has-children"><a href="index-2.html">Home</a><span class="sub-toggle"></span>
            <ul class="sub-menu">
              <li><a href="index-2.html">Homepage 1</a>
              </li>
          ...
          <li class="current-menu-item menu-item-has-children"><a href="about-us.html">Pages</a><span class="sub-toggle"></span>
            <ul class="sub-menu">
              <li><a href="about-us.html">About</a>
              </li>
    ...
    <div id="homepage-1">
      <div class="ps-home-banner">
        <div class="ps-carousel--dots owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="off" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
          <div class="ps-banner ps-banner--1 bg--cover" data-background="{{asset('img/banner/home-1/1.jpg')}}">
            <div class="ps-banner__content">
              <h3>هذا كيك لذيذ</h3>
              <p> هذا نص مولد</p><a class="ps-btn" href="#">تذوق الان</a>
            </div>
          </div>
          <div class="ps-banner ps-banner--1 bg--cover" data-background="{{asset('img/banner/home-1/2.jpg')}}">
            <div class="ps-banner__content">
              <h3>Super Delicious Cake</h3>
              <p>100% Natural, FRESH baked goods</p><a class="ps-btn" href="#"> Book Now</a>
            </div>
          </div>
          <div class="ps-banner ps-banner--1 bg--cover" data-background="{{asset('img/banner/home-1/3.jpg')}}">
            <div class="ps-banner__content">
              <h3>Super Delicious Cake</h3>
              <p>100% Natural, FRESH baked goods</p><a class="ps-btn" href="#"> Book Now</a>
            </div>
      ...
      <div class="ps-section ps-home-about bg--cover" data-background="{{asset('img/bg/home-about.jpg')}}">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
              <div class="ps-section__image"><img src="{{asset('img/homepage/home-1/home-about.png')}}" alt=""></div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
              <div class="ps-section__header">
                <p>هذا النص هو مثال</p>
                <h3>هذا النص هو مثال</h3><i class="chikery-tt3"></i>
              </div>
              <div class="ps-section__content">
                <p>“ هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة  ”</p>
                <div class="ps-section__image"><img src="{{asset('img/homepage/home-1/signature.png')}}" alt=""></div>
                <h5><span>لي شوكوليت</span></h5>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="ps-section ps-home-menu-of-day">
        <div class="ps-section__left">
          <div class="ps-section__header">
            <p>Special Menu</p>
            <h3>Menu of the day</h3><i class="chikery-tt3"></i>
          </div>
          <div class="ps-section__content">
              ...
              <div class="ps-block__header">
                <ul class="ps-tab-list">
                    @foreach($categories as $key => $category)
                        <li id="active-category"><a href="#tab-menu-{{$key + 1}}"><i class="chikery-bk1"></i> {{ $category->name }}</a></li>
                    @endforeach
                </ul>
              </div>
              <div class="ps-tabs">
                @foreach($categories as $key => $category)
                <div class="ps-tab" id="tab-menu-{{$key + 1}}">
                  <div class="row">
                  @foreach($category->products->take(3) as $product)
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                      ...
                      <div class="ps-product--horizontal">
                        <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-default.html"></a><img src="{{asset('img/product/2.png')}}" alt=""/></div>
                        <div class="ps-product__container">
                          ...
                          <div class="ps-product__price"><span>{{$product->category_id}}</span></div>
                        </div>
                      </div>
                      <div class="ps-product--horizontal">
                        <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-default.html"></a><img src="{{asset('img/product/41.png')}}" alt=""/></div>
                        <div class="ps-product__container">
                          <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Red sugar flower</a>
                            <p>Nam ac elit a ante commodo tristique</p>
                          </div>
                      ...
                      <div class="ps-product--horizontal">
                        <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-default.html"></a><img src="{{asset('img/product/9.png')}}" alt=""/></div>
                        <div class="ps-product__container">
                          <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Red sugar flower</a>
                            <p>Nam ac elit a ante commodo tristique</p>
                          </div>
        ...
        <div class="ps-section__right bg--cover" data-background="{{asset('img/bg/home-1/home-menu-of-day.jpg')}}"></div>
      </div>
            ...
            <div class="row">
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 ">
                <div class="ps-product">
                  <div class="ps-product__thumbnail"><img src="{{asset('img/product/17.png')}}" alt=""/><a class="ps-product__overlay" href="product-default.html"></a><span class="ps-badge ps-badge--sale"><i>30%</i></span>
                  </div>
              ...
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 ">
                <div class="ps-product">
                  <div class="ps-product__thumbnail"><img src="{{asset('img/product/31.png')}}" alt=""/><a class="ps-product__overlay" href="product-default.html"></a>
                  </div>
                  <div class="ps-product__content">
                    <div class="ps-product__desc"><a class="ps-product__title" href="product-default.html">Red sugar flower</a>
              ...
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 ">
                <div class="ps-product">
                  <div class="ps-product__thumbnail"><img src="{{asset('img/product/13.png')}}" alt=""/><a class="ps-product__overlay" href="product-default.html"></a><span class="ps-badge ps-badge--new"><i>New</i></span>
                  </div>
                  <div class="ps-product__content">
                    <div class="ps-product__desc"><a class="ps-product__title" href="product-default.html">Red sugar flower</a>
                      <p><span>350g</span><span>30 Min</span><span>120 <sup>o</sup>C</span></p><span class="ps-product__price">$12.00</span>
              ...
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 ">
                <div class="ps-product">
                  <div class="ps-product__thumbnail"><img src="{{asset('img/product/33.png')}}" alt=""/><a class="ps-product__overlay" href="product-default.html"></a>
                  </div>
                  <div class="ps-product__content">
                    <div class="ps-product__desc"><a class="ps-product__title" href="product-default.html">Red sugar flower</a>
                      <p><span>350g</span><span>30 Min</span><span>120 <sup>o</sup>C</span></p><span class="ps-product__price">$12.00</span>
      ...
      <div class="ps-section ps-testimonials bg--cover" data-background="{{asset('img/bg/testimonials.jpg')}}">
        <div class="container">
          <div class="ps-section__header">
            <p>Testimonial</p>
          ...
          <div class="ps-section__content">
            <div class="ps-carousel--dots-2 owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
      ...
      <div class="ps-home-book-table">
        <div class="ps-section__left bg--cover" data-background="{{asset('img/section/book-your-tables/bg.jpg')}}">
          <div class="ps-section__content">
            <p>Video Present</p>
            <h3>Any Design <br/> For Your Feast-day</h3>
            <div class="ps-video"><a href="https://www.youtube.com/watch?v=2_g48Zw0rao"><i class="fa fa-play"></i></a></div>
          </div>
        </div>
        <div class="ps-section__right">
          <form class="ps-form--book-your-table" action="#" method="get">
            <div class="ps-form__header">
              <h4>Chikery Cake</h4>
              <h3>Book your table</h3><i class="chikery-tt3"></i>
